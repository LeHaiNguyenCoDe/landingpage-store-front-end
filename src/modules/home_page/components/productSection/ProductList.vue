        ...
        <div class="relative overflow-hidden">
          ...
          <div class="p-[1vw] space-y-[0.3vw] md:h-13vw xl:h-fit h-25vw flex flex-col justify-center">
            ...
            <div class=" flex gap-0.5vw items-center self-center">
              ...
              <span v-if="product.oldPrice" class="text-gray-400 inline-flex line-through xl:ml-2 text-center f-text-6-16">
                Rp {{ product.oldPrice.toLocaleString() }}
              </span>
            </div>
            <div class="h-4vw relative -mx-1vw">
              <div class="absolute bottom-0 inset-0 flex flex-col space-y-[0.3vw] items-center h-3vw text-center text-md bg-white text-title opacity-0 group-hover:opacity-100 transition-all duration-1000 ">
